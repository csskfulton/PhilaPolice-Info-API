...
SET time_zone = "+00:00";
CREATE DATABASE IF NOT EXISTS `PhillyPolice` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `PhillyPolice`;
...
CREATE TABLE `DCNumber` (
  `ID` int(20) NOT NULL,
  `DCNumber` varchar(30) DEFAULT NULL,
  `DistrictNumber` varchar(3) DEFAULT NULL,
  `DetectiveDivision` varchar(50) DEFAULT NULL,
  `DetectiveName` varchar(100) DEFAULT NULL,
  `ContactNumber` varchar(30) NOT NULL,
  `NewsStoryID` int(20) DEFAULT NULL,
...
CREATE TABLE `UnsolvedMurders` (
  `ID` int(99) NOT NULL,
  `TimeStamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `DCNumber` varchar(50) DEFAULT NULL,
  `VictimName` varchar(50) DEFAULT NULL,
  `NewsURL` varchar(1000) DEFAULT NULL,
  `Description` varchar(2000) NOT NULL,
  `ScrapeHash` varchar(65) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `USMImages` (
  `ID` int(99) NOT NULL,
  `TimeStamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `UCMurderURL` varchar(1000) NOT NULL,
  `DCNumber` varchar(50) DEFAULT NULL,
  `ScrapeHash` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `UnsolvedMurders`
  ADD UNIQUE KEY `ID` (`ID`);

ALTER TABLE `USMImages`
  ADD UNIQUE KEY `ID` (`ID`);
...
ALTER TABLE `Calendar`
  MODIFY `ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2485;
ALTER TABLE `CrimeIncidents`
  MODIFY `ID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164070;
ALTER TABLE `CrimeTypes`
  MODIFY `ID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
ALTER TABLE `CurrentHash`
  MODIFY `ID` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
ALTER TABLE `DCNumber`
  MODIFY `ID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=608;
ALTER TABLE `Devices`
...
ALTER TABLE `NewsStory`
  MODIFY `ID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1512;
ALTER TABLE `PSA`
  MODIFY `ID` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
ALTER TABLE `ScrapeHashHistory`
  MODIFY `ID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7068;
ALTER TABLE `Shooting`
  MODIFY `ID` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2001;
ALTER TABLE `UCVideos`
  MODIFY `ID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=289;
ALTER TABLE `UnsolvedMurders`
  MODIFY `ID` int(99) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=398;
ALTER TABLE `USMImages`
