...
ALTER TABLE `Calendar`
  MODIFY `ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2167;
ALTER TABLE `CrimeIncidents`
  MODIFY `ID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138249;
ALTER TABLE `CrimeTypes`
...
ALTER TABLE `NewsStory`
  MODIFY `ID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1291;
ALTER TABLE `PSA`
  MODIFY `ID` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
ALTER TABLE `ScrapeHashHistory`
  MODIFY `ID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5661;
ALTER TABLE `Shooting`
  MODIFY `ID` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1666;
ALTER TABLE `UCVideos`
